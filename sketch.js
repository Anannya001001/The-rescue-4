...
keys = createSprite(150,190,10,10);
...
if(gameState === 1){
  if (keyIsDown(UP_ARROW)){
   ...
   textSize(12)
   fill(0)
   text("move left",25,220);
   text("move right",225,220);
   text("jump",140,125);
...
else if (gameState===2)
{
  textSize(25)
  fill("red")
  text("Game Over!", 125,170)
  text("You were unable to survive",50,230)
  savior.x = 430
  savior.y = 60
  textSize (12)
  text("Press enter to restart!",500,50)
  keys.visible = false
  if(keyIsDown(13)){
    gameState = 1
  }
...
else if (gameState===3)
{
  textSize(25)
  fill("orange")
  text("You Won!", 125,170)
  text("You were able to survive",50,230)
  savior.x = 430
  savior.y = 60
  textSize (12)
  text("Press enter to restart!",500,50)
